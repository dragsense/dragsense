...
export default function Setting() {
  ...
  const onChangeHomePage = (value, option) => {
    ...
    if (!value) state.homePage = undefined;
    else {
  ...
  const onChangeErrorPage = (value, option) => {
    ...
    if (!value) state.errorPage = undefined;
    else {
  ...
  const onChangeMaintenancePage = (value, option) => {
    ...
    if (!value) state.maintenancePage = undefined;
    else {
  ...
  const onChangeSearchPage = (value, option) => {
    ...
    if (!value) state.searchPage = undefined;
    else {
  ...
  const onSelectImage = (image) => {
    const newImage = image[0] ? image[0] : { _id: -1, src: "", alt: "" };

    if (mediaModal.type)
      setState({
        ...state,
        images: { ...state.images, [mediaModal.type]: newImage },
      });
  ...
  const onChangeMobileLogo = (value) => {
    setState({
      ...state,
      images: { ...state.images, mobileLogo: value.trim() },
    });
  };
  ...
  const onChangePlaceHolder = (value) => {
    setState({
      ...state,
      images: { ...state.images, placeholder: value.trim() },
    });
  };
  ...
  return (
    <>
      <Card loading={isLoading} title={`Setting:`} headStyle={{ padding: 10 }}>
        <Form layout="vertical" form={form} initialValues={{}}>
          <Row gutter={16}>
            <Col span={12}>
              ...
              <Form.Item label="Keywords" className="font-500">
                <TextArea
                  rows={4}
            ...
            <Col span={12}>
              ...
              <Form.Item label="Home Page" className="font-500">
                <Select
                  ...
                  onSearch={(v) => {
                    if (!state.loading) setPageSearch(v);
                  }}
                ...
                >
                  ...
                  {states.pages.map((page) => (
                    <Option value={page._id} label={page.name}>
                      {page.name}
                    </Option>
                  ))}
                </Select>
              ...
              <Form.Item label="Error Page" className="font-500">
                ...
                >
                  <Option value="">None</Option>
                  {state.errorPage && state.errorPage?._id !== "" && (
                    <Option
                      key={0}
                      disabled
                      value={state.errorPage._id}
                      label={state.errorPage.name}
                    >
                      {state.errorPage.name}
                    </Option>
                  )}
                ...
                >
                  ...
                  {state.maintenancePage && (
                    <Option
                      ...
                      disabled
                      value={state.maintenancePage._id}
                      label={state.maintenancePage.name}
                    >
                      {state.maintenancePage.name}
                    </Option>
                  )}
          ...
          <Row gutter={16}>
            <Col span={12}>
              ...
              <Form.Item label="Host" className="font-500">
                <Input
                  ...
                  onChange={(e) => {
                    setState({
                      ...state,
                      email: { ...state.email, host: e.target.value },
                    });
                    setIsChange(true);
                  }}
                  maxLength={1000}
              ...
              <Form.Item label="Port" className="font-500">
                <Input
                  ...
                  onChange={(e) => {
                    setState({
                      ...state,
                      email: { ...state.email, port: e.target.value },
                    });
              ...
              <Form.Item label="isSecure?" className="font-500">
                <Checkbox
                  ...
                  onChange={() => {
                    setState({
                      ...state,
                      email: { ...state.email, secure: !state.email.secure },
                    });
                    setIsChange(true);
                  }}
                ...
                <Checkbox
                  ...
                  onChange={() => {
                    setState({
                      ...
                      email: {
                        ...state.email,
                        ignoreTLS: !state.email.ignoreTLS,
                      },
                    });
                    setIsChange(true);
                  }}
              ...
              <Divider orientation="left" orientationMargin="0">
                {" "}
                {"Email Auth"}{" "}
                <Tooltip title="SMTP Authentication, often abbreviated SMTP AUTH, is an extension of the Simple Mail Transfer Protocol (SMTP) whereby a client may log in using any authentication mechanism supported by the server.">
                  <QuestionCircleFilled />
                </Tooltip>
              </Divider>
                ...
                <Input
                  ...
                  onChange={(e) => {
                    setState({
                      ...
                      email: {
                        ...state.email,
                        auth: { ...state.email.auth, user: e.target.value },
                      },
                    });
                    setIsChange(true);
                  }}
                ...
                <Input.Password
                  ...
                  onChange={(e) => {
                    setState({
                      ...
                      email: {
                        ...state.email,
                        auth: { ...state.email.auth, pass: e.target.value },
                      },
                    });
                    setIsChange(true);
                  }}
            ...
            <Col span={12}>
              ...
              <Form.Item label="From" className="font-500">
                <Input
                  ...
                  onChange={(e) => {
                    setState({
                      ...state,
                      email: { ...state.email, from: e.target.value },
                    });
                    setIsChange(true);
                  }}
                  maxLength={1000}
              ...
              >
                <Input
                  placeholder="Enter To addresses separated by commas"
                  name="email"
                  onChange={(e) => {
                    setState({
                      ...state,
                      email: { ...state.email, to: e.target.value },
                    });
                    setIsChange(true);
                  }}
                  maxLength={1000}
              ...
              >
                <Input
                  ...
                  onChange={(e) => {
                    setState({
                      ...state,
                      email: { ...state.email, cc: e.target.value },
                    });
                    setIsChange(true);
                  }}
                  maxLength={1000}
              ...
              >
                <Input
                  ...
                  onChange={(e) => {
                    setState({
                      ...state,
                      email: { ...state.email, bcc: e.target.value },
                    });
                    setIsChange(true);
                  }}
                  maxLength={1000}
              ...
              <Form.Item label="Reply To" name={["email", "replyTo"]}>
                <Input
                  ...
                  onChange={(e) => {
                    setState({
                      ...state,
                      email: { ...state.email, replyTo: e.target.value },
                    });
                    setIsChange(true);
                  }}
