        ...
        {state.type == 'boolean' ?
            ...
            : state.type == 'image' || state.fileType == 'images' ?
                ...
                : state.type == 'content' ?
                    ...
                    :
                    state.type == 'video' || state.fileType == 'videos' ?
                        <>
                        ...
                        :
                        state.type == 'audio' || state.fileType == 'audios' ?
                            <Form.Item label="srcs:">
                                <Button onClick={() => {
                                    setType('audios')
                            ...
                            : state.type == 'doc' || state.fileType == 'docs' ?
                                <Form.Item label="src:">
                                    <Button onClick={() => {
                                        setType('docs')
                                ...
                                <><Form.Item label="Default Value" className="font-500">
                                    {state.type === 'text' || state.type === 'textarea' ?
                                        ...
                                        />
                                        : state.type !== 'file' && <Input placeholder="Default Value" name="defaultValue"
                                            onChange={onChange}
                                            style={{ width: 420 }}
                                            maxLength={100}
                                            value={state.defaultValue}
