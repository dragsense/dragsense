...

        {
            variable.type === 'font' ? <>
                <div style={{ fontFamily: `"${font?.fontFamily}", sans-serif` }}>
                    ...
                    <p style={{ [selectedOption]: variable.value }}>Lorem ipsum, or lipsum as it is <i>sometimes</i> known, is <strong>dummy text</strong> used in laying out <em>print</em>, <b>graphic</b> or web designs. </p>
                ...
                variable.type === 'size' ?
                    <div style={{ fontFamily: `"${font?.fontFamily}", sans-serif` }}>
                        ...
                        {selectedSize === 'width' ?
                            ...
                            :
                            selectedSize === 'height' ?
                                <div style={{ background: '#d67822', width: '100%', height:variable.value  }}>
                                </div>
                                : selectedSize === 'border' ? <div
                                    style={{
                                        border: `${variable.value} solid #2fc1ff`,
                                        width: '100%', boxSizing: 'border-box', height: 400
                                    }}>

                                </div> : <div style={{
                                    border: `2px solid #2fc1ff`,
                                    borderRadius: variable.value, width: '100%', height: 400
                                }}>
                    ...
                    <div style={{ fontFamily: `"${font?.fontFamily}", sans-serif` }}>
                        ...
                        {selectedSpace === 'margin' ? <div style={{ border: `2px solid #2fc1ff`, display: 'inline-block' }}>
                            <div style={{
                                background: '#d67822',
                            ...
                            : <div style={{ border: `2px solid #2fc1ff`, display: 'inline-block',  padding: variable.value, }}>
                            Content
                            </div>
                            }
