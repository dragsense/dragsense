...
import { AiFillFile, AiOutlineEdit, AiFillDatabase, AiOutlineCopy, AiOutlineSetting, AiOutlineDelete } from 'react-icons/ai';
...
const FormList = ({ forms, page, onClone, total, setPage, onEdit, onDelete, onEditDocuments }) => {
            ...
            render: (text, record) => (
                <Space size="middle">
                    ...
                    <Tooltip title="Edit Form Elements">
                        ...
                        }} className="ac-icon2" size="2em" /></Tooltip>
                    <Tooltip title="Edit Form">
                        <Button icon={<AiOutlineSetting size="1.5em" />}
                            onClick={async (e) => {
                    ...
                    <Tooltip title="Edit Form Entries"><Button icon={<AiFillDatabase size="1.5em" />}
                        onClick={async (e) => {
    ...
    return <Table columns={columns} dataSource={forms} pagination={{
        total: total,
        current: page,
        pageSize: 10,
    }}
