...
import { Input, Button, Form, Typography, Alert, Divider, Progress } from 'antd';
    ...
    const onSubmit = async (e) => {
        ...
        form
            ...
            .then(async (values) => {
                ...
                try {
                    await fetcher('/api/users/reset', {
                        method: 'POST',
                        headers: {
                            'Content-Type': 'application/json',
                        },
                        body: JSON.stringify({ ...values, token, confirmPassword: undefined }),
                    });
                    router.query.status = 2;
