...
handler.get(async (req, res) => {
    try {
        ...
        addFilesToZip('../laravel-demo', '', zip, project,  ['autocode-custom-style.css', 'autocode-custom-index.js', 'node_modules', 'package-lock.json', 'private', '.env', 'vendor', 'storage', 'public', 'composer.lock']);
